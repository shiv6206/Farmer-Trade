...
const storedRole =
    sessionStorage.getItem("aapki mandiUserRole");

const signupRole =
    sessionStorage.getItem("aapki mandiSignupRole");
...
function setupRoleContent() {
    ...
    if (userRole === "farmer") {
        ...
        supportDescription.textContent =
            "Get help with selling your produce, finding buyers, market prices, your account and everything you need to make the most of aapki mandi.";
    ...
    if (userRole === "buyer") {
        ...
        supportDescription.textContent =
            "Get help finding produce, connecting with farmers, understanding market prices, managing your account and everything else you need on aapki mandi.";
        ...
        noteDescription.textContent =
            "Tell us what produce you need and what you're trying to find. We'll help you understand the right direction on aapki mandi.";
    ...
    supportDescription.textContent =
        "Get help with your account, market information, produce listings, buying and anything else you need while using aapki mandi.";
