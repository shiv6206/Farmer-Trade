...
function setupRoleContent() {
    ...
    if (userRole === "buyer") {
        ...
        notificationDescription.textContent =
            "Stay informed about new produce, seller activity, market prices and important aapki mandi updates.";
    ...
    notificationDescription.textContent =
        "Stay informed about your produce, buyer interest, market activity and important aapki mandi updates.";
...
const farmerNotifications = [
...

    {
        ...
        title:
            "Welcome to aapki mandi",

        message:
            "Your account is ready. Explore market prices and connect with buyers through aapki mandi.",
...
const buyerNotifications = [
...

    {
        ...
        message:
            "Your buyer account is ready. Explore produce listings and connect with farmers through aapki mandi.",
