    ...
    async function (event) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                sessionStorage.setItem("aapki mandiUserRole", data.user.role.toLowerCase());
                sessionStorage.setItem("aapki mandiLoggedIn", "true");
                sessionStorage.setItem("aapki mandiLoginMobile", mobile);
