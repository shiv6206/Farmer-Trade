...
profileMenus.forEach(function (profileMenu) {
    ...
    if (logoutButton) {
        logoutButton.addEventListener("click", function () {
            ...
            sessionStorage.removeItem("Farmer TradeUserRole");
            sessionStorage.removeItem("Farmer TradeLoggedIn");
            sessionStorage.removeItem("Farmer TradeLoginMobile");
            sessionStorage.removeItem("Farmer TradeSignupRole");
